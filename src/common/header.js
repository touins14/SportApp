    ...
    return (
      <Navbar.Header {...this.props}>
        <Navbar.Brand tabIndex='-1'>
          <a href='#'>
            <img src='/imgs/common/logoSportApp.png' alt='rubix' width='120' height='50' style={{marginTop:-8}}/>
          </a>
        </Navbar.Brand>
      </Navbar.Header>
    );
    ...
    return (
      <Nav pullRight>
        <Nav className='hidden-xs'>
          ...
          <NavItem divider />
          <DirectNavItem glyph='user-female' eventKey={3} path={::this.getPath('Organiser/OrganiserProfilOrganiser')} className='small-font' style={{position: 'relative', top: 2}} />
          <SettingsMenu />
          <NavItem divider />
  ...
  render() {
    return (
      <Grid id='navbar' {...this.props}>
        <Row>
          <Col xs={12}>
            <Navbar fixedTop fluid id='rubix-nav-header' style={{background:'#43496a'}}>
              <Row>
                <Col xs={3} visible='xs'>
                  <SidebarBtn />
                </Col>
