...
export default class ProfilTeamOrganiser extends React.Component {
constructor(props) {
      super(props);
                ...
                <div className="rating" style={{marginRight:20,marginTop:-90}}>
                  ...
                  <a href="#1" title="Give 1 stars" style={{marginLeft:20}}>☆</a>
                   ...
                   <div>
                    ...
                    <DropdownButton bsStyle='lightblue' title='Compétitions' id='dropdown-basic' style={{marginRight:500,marginTop:-50}}>
               ...
               <div style={{marginLeft:90,marginTop:20}}>
                ...
                <div style={{marginTop:45}}>
                          <div>
                            ...
                            <Badge className='bg-blue fg-white'style= {{marginRight:220,marginTop:13}}>
                              Goolkeeper
                            </Badge>
                  ...
                  <a href="#2" title="Give 2 stars" >☆</a>
                     <a href="#1" title="Give 1 star">☆</a>
                      ...
                      <div>
                            ...
                            <Badge className='bg-blue fg-white'style= {{marginRight:220,marginTop:-95}}>
                              Midfielder
                            </Badge>
